...
const MovieDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white">
      ...
      >
        <button onClick={() => navigate(-1)} className="absolute top-1 m-8 mb-4 bg-red-600 hover:bg-red-700 cursor-pointer text-white font-bold px-4 py-2 rounded z-20">
            ← Back
        </button>
        ...
        <div className="relative z-20 max-w-7xl mx-auto w-full flex items-center p-8 md:p-16">
          ...
          <div className="w-full text-white">
            ...
            <button className="bg-red-600 hover:bg-red-700 cursor-pointer text-white font-bold py-3 px-8 rounded transition duration-200 text-xl">
              Book Now
            </button>
          </div>
        </div>
